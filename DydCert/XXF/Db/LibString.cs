...
namespace XXF.Db
{
    public static class LibString
    {
        ...
        public static string StrAddNumber(string Source, int Number)
        {
            ...
            if (Source == "") return Number.ToString();
            string Head = "";
            string Num = "";
        ...
        {
            DateTime dRet;
            return DateTime.TryParse(strDate, out dRet);
        }
        ...
        /// <returns></returns>
        public static string GetStringToBm(string Str, string Split)
        {
            int p = Str.IndexOf(Split);
            if (p == -1)
                return Str;
            else
        ...
        /// <param name="Split">间隔符</param>
        /// <returns></returns>
        public static string GetStringToMc(string Str, string Split)
        {
            int p = Str.IndexOf(Split);
            if (p == -1)
                return "";
            else
                return Str.Substring(p + Split.Length, Str.Length - p - Split.Length);
        }

        #region private static string[] strChineseCharList
        ...
        /// </summary>
        /// <returns></returns>
        public static string MakeRandomNumber(int n)
        {
