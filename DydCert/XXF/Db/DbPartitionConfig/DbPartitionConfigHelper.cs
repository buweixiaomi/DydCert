...
namespace XXF.Db.DbPartitionConfig
{
    /// <summary>
    /// Db分区配置帮助类
    /// </summary>
    public class DbPartitionConfigHelper
    {
        //缓存key标识
        private static string configKey = "DbPartitionConfig"; //+ DateTime.Now.ToString("yyyyMMddHHmmss");
        private static readonly int intervalTime = 10;//单位秒
        public static Dictionary<string, tb_dbpartition_config_model> configData = new Dictionary<string, tb_dbpartition_config_model>();
        public static XXF.Cache.ConfigCacheProvider<List<tb_dbpartition_config_model>> configCacheProvider = new XXF.Cache.ConfigCacheProvider<List<tb_dbpartition_config_model>>(configKey, RefreshData, RefreshDataByLocalFile, intervalTime);
        ...
        /// <returns></returns>
        private static void RefreshDataByLocalFile(List<tb_dbpartition_config_model> dic)
        {
        ...
        {
            string keyTemp = "DbPartitionConfig_{0}";
        ...
        ///// </summary>
        ///// <returns></returns>
        //private static object RefreashDbPartitionConfigCache()
        //{
        //    var isEnabledDepotsConnectByConfig = XXF.Common.XXFConfig.IsEnabledDepotsConnectByConfig;
        //    if (string.IsNullOrWhiteSpace(isEnabledDepotsConnectByConfig) ||
        //        isEnabledDepotsConnectByConfig.ToLower() == "false")
        ...
        //        {
        //            conn.Open();
        //            var list = new Dal.tb_dbpartition_config_dal().Get(conn);
        //            return list;
        //        }
        //    }
        //    else
        ...
        /// </summary>
        /// <returns></returns>
        public static List<Model.tb_dbpartition_config_model> GetCacheConfig()
        {
            if (configData.Count() == 0)
            {
                return new List<tb_dbpartition_config_model>();
            }
            List<tb_dbpartition_config_model> models = new List<tb_dbpartition_config_model>(configData.Values);
            return models;
            //var o = Cache.CacheFileProvider.GetCache(configKey);
            //if(o == null)
            //    return new List<Model.tb_dbpartition_config_model>();
            //else
            //    return (o as Cache.CacheFileInfo).CacheData as List<Model.tb_dbpartition_config_model>;
        }
    }
}
